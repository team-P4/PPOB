<div id="sidebar">
			<div id="sidebar-wrapper">
				<div class="sidebar-title">
					<span class="text-size-40 text-loose">PPOB Jaya Kusuma</span><br>
					<span class="text-size-18 text-grey">Melayani dengan sepenuh hati</span>
				</div>
				<div class="sidebar-avatar">
					<div class="sidebar-avatar-image"><img src="" alt="" class="img-circle"></div>
					<div class="sidebar-avatar-text">User</div>
				</div>
